package com.manh.ecom_be.responses.user;
...
public class UserResponse extends BaseResponse {
    ...
    @JsonProperty("date_of_birth")       private Date dateOfBirth;
    @JsonProperty("facebook_account_id") private String facebookAccountId;
    @JsonProperty("google_account_id")   private String googleAccountId;
